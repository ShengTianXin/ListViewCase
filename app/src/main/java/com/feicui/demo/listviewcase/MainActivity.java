...
//        addMoreView(listView);
    ...
    private void addMoreView(ListView listView) {
        //拿到moreView
        View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.view_more,null);
        //listView添加foot布局
        listView.addFooterView(view);

        final Button moreBtn = (Button) view.findViewById(R.id.view_more_btn);
        final ProgressBar morePb = (ProgressBar) view.findViewById(R.id.view_more_pd);
        //加载更多
